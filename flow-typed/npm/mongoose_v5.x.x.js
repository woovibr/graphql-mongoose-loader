...
declare class Mongoose$Query<Result, Doc> extends Promise<Result> {
  ...
  merge(source: Mongoose$Query<Result, Doc>): Mongoose$Query<Result, Doc>;
  model: Class<Mongoose$Document>;
}
...
declare class Aggregate$Query extends Promise<any> {
  ...
  count(str: string): Promise<number | Object[]>;
  ...
  pipeline(): Object[];
  project(opts?: string | Object): Aggregate$Query;
...
declare module 'mongoose' {
  ...
  declare export type AggregateQuery = Aggregate$Query;
